...
('낚시꾼', '생선', '와인과 어울리는 다양한 생선 요리를 소개합니다.', '회 한접시 어때요?', '서래포구', '와인', 12, '생선.jpg', 'wine_fish_org.jpg'),
...
VALUES
(1, 'user1', '추천 너무 감사합니다!', 2),
(2, 'user2', '다음에 또 먹을겁니다!!', 2),
(3, 'user3', '오랜만이네요!!', 3),
(4, 'user4', '기대 이하였어요.', 1),
(5, 'user5', '친절하고 맛있었습니다.', 2),
(6, 'user6', '재시도 의사 없습니다', 1),
(7, 'user7', '추천합니다!', 2),
(8, 'user8', '가격 대비 별로였습니다.', 1),
(9, 'user9', '최고의 경험이었어요.', 1),
(10, 'user10', '보통이었어요.', 2),
(11, 'user11', '정말 훌륭했어요!', 1),
(1, 'user12', '시간 나면 다음에도!!', 3),
(2, 'user13', '매우 만족했습니다.', 3),
(3, 'user14', '별로였어요.', 3),
(1, 'user15', '좋은 추억 만들었어요.', 1),
(16, 'user16', '실망했어요.', 2),
(17, 'user17', '기대 이상이었어요!', 1),
(18, 'user18', '돈이 아깝습니다.', 1),
(2, 'user19', '완벽했어요!', 3),
(4, 'user20', '더 맛있는 거 많아요', 2);
